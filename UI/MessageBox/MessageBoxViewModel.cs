...
namespace PrinterCenter.UI
{
	internal class MessageBoxViewModel : INotifyPropertyChanged
	{
		...
		private TRMessageBoxWindow _view;
		...
		public Visibility ImageVisibility
		{
			...
			set
			{
				if (_imageVisibility != value)
				{
					...
					NotifyPropertyChange("ImageVisibility");
				}
			}
		}
		...
		private void SetImageSource(MessageBoxImage image)
		{
			switch (image)
			{
				...
				case MessageBoxImage.Error:
					MessageImageSource = new BitmapImage(new Uri(@"Images\ErrorIcon.png", UriKind.Relative));
					break;

				//case MessageBoxImage.Exclamation:
				case MessageBoxImage.Warning:
					MessageImageSource = new BitmapImage(new Uri(@"Images\WarningIcon.png", UriKind.Relative));
					break;

				case MessageBoxImage.Question:
					MessageImageSource = new BitmapImage(new Uri(@"Images\QuestionIcon.png", UriKind.Relative));
					break;

				//case MessageBoxImage.Asterisk:
				case MessageBoxImage.Information:
					MessageImageSource = new BitmapImage(new Uri(@"Images\InformationIcon.png", UriKind.Relative));
					break;
